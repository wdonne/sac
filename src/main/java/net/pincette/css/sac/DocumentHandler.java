...
public interface DocumentHandler {
    ...
    /**
     * This is the URI value that is used when a selector or attribute
     * condition must not match if a namespace URI is present on the element or
     * attribute respectively.
     * @see AttributeCondition
     * @see ElementSelector
     */
    public static final String SAC_NO_URI = "SAC_NO_URI";
    ...
    /**
     * Receive notification of the beginning of a margin box statement.
     *
     * The Parser will invoke this method at the beginning of every margin box
     * statement in the style sheet. there will be a corresponding
     * endMarginBox() event for every startMargin() event.
     *
     * @param name the name of the margin box (if any, null otherwise)
     * @exception CSSException Any CSS exception, possibly wrapping another
     *                         exception.
     */
    public void startMarginBox(String name) throws CSSException;

    /**
     * Receive notification of the end of a margin box statement.
     *
     * @param name the name of the margin box (if any, null otherwise)
     * @exception CSSException Any CSS exception, possibly wrapping another
     *                         exception.
     */
    public void endMarginBox(String name) throws CSSException;
